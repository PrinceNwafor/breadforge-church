/* ==========================================================================
   THE BREADFORGE CHURCH — MAIN JAVASCRIPT
   Eklektos Apostolic Network | Ikorodu, Lagos, Nigeria
   ========================================================================== */
...
(function () {
  ...
  handleFormSubmit('visit-form', 'Thank you! We\'ll reach out before Sunday.');
  handleFormSubmit('newsletter-form', 'You\'re subscribed! Welcome to the Breadforge family.');
  ...
  function showToast(message, type = 'success') {
    ...
    Object.assign(toast.style, {
      ...
      background: type === 'success' ? '#3D200A' : '#D4621A',
      color: 'white', padding: '14px 24px', borderRadius: '40px',
      fontFamily: 'Inter, sans-serif', fontSize: '14px', fontWeight: '500',
      display: 'flex', alignItems: 'center', gap: '8px',
      boxShadow: '0 8px 32px rgba(61,32,10,0.25)', zIndex: '9999',
  ...
  function openVideoModal(videoId, platform = 'youtube') {
    ...
    Object.assign(backdrop.style, { position:'absolute', inset:'0', background:'rgba(0,0,0,0.88)', backdropFilter:'blur(8px)' });
